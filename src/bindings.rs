...
pub const IO_URING_VERSION_MINOR: u32 = 8;
...
extern "C" {
    #[link_name = "liburing_sanitize_ring__extern"]
    pub fn liburing_sanitize_ring(ring: *mut io_uring);
}
extern "C" {
    #[link_name = "liburing_sanitize_address__extern"]
    pub fn liburing_sanitize_address(addr: *const ::std::os::raw::c_void);
}
extern "C" {
    #[link_name = "liburing_sanitize_region__extern"]
    pub fn liburing_sanitize_region(
        addr: *const ::std::os::raw::c_void,
        len: ::std::os::raw::c_uint,
    );
}
extern "C" {
    #[link_name = "liburing_sanitize_iovecs__extern"]
    pub fn liburing_sanitize_iovecs(iovecs: *const iovec, nr: ::std::os::raw::c_uint);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
